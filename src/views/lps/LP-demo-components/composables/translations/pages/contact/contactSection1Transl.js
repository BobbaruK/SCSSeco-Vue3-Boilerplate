const contactSection1Transl = () => {
  const title = {
    ...
    en: "Demo Components - Contact",
    it: "Demo Components - Contact",
    tr: "Demo Components - Contact",
    ro: "Demo Components - Contact",
    hu: "Demo Components - Contact",
    ar: "Demo Components - Contact",
    de: "Demo Components - Contact",
    es: "Demo Components - Contact",
    sv: "Demo Components - Contact",
    pt: "Demo Components - Contact",
    fi: "Demo Components - Contact",
    pl: "Demo Components - Contact",
    th: "Demo Components - Contact",
    ms: "Demo Components - Contact",
  };
...
export default contactSection1Transl;
