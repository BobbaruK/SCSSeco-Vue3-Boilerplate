const demoSection1Transl = () => {
  const title = {
    ...
    en: "Demo Components en",
    it: "Demo Components it ",
    tr: "Demo Components tr",
    ro: "Demo Components ro",
    hu: "Demo Components hu ",
    ar: "Demo Components ar",
    de: "Demo Components de",
    es: "Demo Components es",
    sv: "Demo Components sv",
    pt: "Demo Components pt",
    fi: "Demo Components fi",
    pl: "Demo Components pl",
    th: "Demo Components th",
    ms: "Demo Components ms",
  };
