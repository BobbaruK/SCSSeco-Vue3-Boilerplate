const servicesSection1Transl = () => {
  const title = {
    ...
    en: "Demo Components - Services",
    it: "Demo Components - Services",
    tr: "Demo Components - Services",
    ro: "Demo Components - Services",
    hu: "Demo Components - Services",
    ar: "Demo Components - Services",
    de: "Demo Components - Services",
    es: "Demo Components - Services",
    sv: "Demo Components - Services",
    pt: "Demo Components - Services",
    fi: "Demo Components - Services",
    pl: "Demo Components - Services",
    th: "Demo Components - Services",
    ms: "Demo Components - Services",
  };
