...
const formTranslations = (lang, obj) => {
  ...
  const agreementTransl = {
    ...
    tr: `Evet, benimle ${process.env.VUE_APP_BRAND_TITLE} tarafından iletişime geçilmesini kabul ediyorum`,
    ro: `Da, sunt de acord să primesc comunicări de la ${process.env.VUE_APP_BRAND_TITLE}`,
    hu: `Elfogadom, hogy kommunikációs anyagot kapjak ${process.env.VUE_APP_BRAND_TITLE}-tól`,
    ar: `نعم، أوافق على تلقي الاتصالات من ${process.env.VUE_APP_BRAND_TITLE}`,
    ...
    sv: `Ja, jag samtycker till att ta emot meddelanden från ${process.env.VUE_APP_BRAND_TITLE}`,
    ...
    pl: `Tak, wyrażam zgodę na otrzymywanie wiadomości od ${process.env.VUE_APP_BRAND_TITLE}`,
  ...
  const gdprTransl = {
    ...
    pt: "",
    fi: "Hyväksyn täten henkilötietojeni käsittelyn ja siirtämisen kolmansille osapuolille ja sen, että kyseiset osapuolet voivat ottaa minuun yhteyttä saadakseen yhteydenpitoa tuotteista tai palveluista.",
