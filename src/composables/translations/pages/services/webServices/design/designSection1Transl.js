const designSection1Transl = () => {
  const title = {
    ...
    ro: "Services - web - design",
    hu: "Services - web - design",
    ar: "Services - web - design",
    de: "Services - web - design",
    es: "Services - web - design",
    sv: "Services - web - design",
    pt: "Services - web - design",
    fi: "Services - web - design",
    pl: "Services - web - design",
    th: "Services - web - design",
    ms: "Services - web - design",
  };
...
export default designSection1Transl;
