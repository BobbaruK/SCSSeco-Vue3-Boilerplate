const codeSection1Transl = () => {
  const title = {
    ...
    en: "Services - web - code",
    it: "Services - web - code",
    tr: "Services - web - code",
    ro: "Services - web - code",
    hu: "Services - web - code",
    ar: "Services - web - code",
    de: "Services - web - code",
    es: "Services - web - code",
    sv: "Services - web - code",
    pt: "Services - web - code",
    fi: "Services - web - code",
    pl: "Services - web - code",
    th: "Services - web - code",
    ms: "Services - web - code",
  };
...
export default codeSection1Transl;
