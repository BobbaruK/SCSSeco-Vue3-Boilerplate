...
<template>
  <nav class="scsseco-menu">
    <div class="site-logo">
      <router-link :to="{ name: 'Demo1Home' }" class="logo">Logo</router-link>
    </div>
    ...
    <div class="menu-wrapper" @mouseenter="hoverSetDesktop">
      <ul class="menu">
        <li>
          <router-link :to="{ name: 'Demo1Home' }" @click="resetStyles">Home</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo1About' }" @click="resetStyles">About</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo1Services' }" @click="resetStyles">Services</router-link>
        </li>
        ...
        <li>
          <router-link :to="{ name: 'Demo1Contact' }" @click="resetStyles">Contact</router-link>
        </li>
      </ul>
    </div>
  </nav>
