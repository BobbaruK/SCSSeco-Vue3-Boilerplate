...
<template>
  ...
  <ul class="menu" :class="{ open: isMobileOpen, mobile: isMobileViewport }">
    <li>
      <router-link
        :to="{ name: 'Demo3Home', params: { lang: lang } }"
        @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >Home</router-link
      >
    </li>
    <li>
      <router-link :to="{ name: 'Demo3About' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >About</router-link
      >
    </li>
    <li>
      <router-link :to="{ name: 'Demo3Services' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
    ...
    <li>
      <router-link :to="{ name: 'Demo3Contact' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >Contact</router-link
      >
    </li>
  </ul>
