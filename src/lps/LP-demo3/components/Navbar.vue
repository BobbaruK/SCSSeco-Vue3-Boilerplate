...
<template>
  ...
  <nav class="scsseco-menu">
    ...
    <div class="menu-wrapper" @mouseenter="hoverSetDesktop">
      <ul class="menu">
        <li>
          <router-link :to="{ name: 'Demo3Home' }" @click="resetStyles">Home</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo3About' }" @click="resetStyles">About</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo3Services' }" @click="resetStyles">Services</router-link>
        </li>
        ...
        <li>
          <router-link :to="{ name: 'Demo3Contact' }" @click="resetStyles">Contact</router-link>
        </li>
      </ul>
    </div>
  </nav>
