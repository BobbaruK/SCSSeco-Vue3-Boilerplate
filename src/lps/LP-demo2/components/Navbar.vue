...
<template>
  <nav class="scsseco-menu">
    <div class="site-logo">
      <router-link :to="{ name: 'Demo2Home' }" class="logo">Logo</router-link>
    </div>
    ...
    <div class="menu-wrapper" @mouseenter="hoverSetDesktop">
      <ul class="menu">
        <li>
          <router-link :to="{ name: 'Demo2Home' }" @click="resetStyles">Home</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo2About' }" @click="resetStyles">About</router-link>
        </li>
        <li>
          <router-link :to="{ name: 'Demo2Services' }" @click="resetStyles">Services</router-link>
        </li>
        <li data-dropdown @click.stop.prevent="listItemClick">
          <router-link to="/" custom v-slot="{ isActive, isExactActive }">
            <span
              class="link-item"
            ...
            <ul class="sub-menu">
              <li data-dropdown @click.stop.prevent="listItemClick">
                ...
                <div class="dropdown">
                  <ul class="sub-menu">
                    <li>
                      <router-link to="/" @click="resetStyles">GrandChild1</router-link>
                    </li>
                    <li>
                      <router-link to="/" @click="resetStyles">GrandChild2</router-link>
                    </li>
                  </ul>
                </div>
              </li>
        ...
        <li>
          <router-link :to="{ name: 'Demo2Contact' }" @click="resetStyles">Contact</router-link>
        </li>
      </ul>
    </div>
  </nav>
