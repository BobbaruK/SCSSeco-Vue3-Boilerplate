...
<template>
  ...
  <ul class="menu" :class="{ open: isMobileOpen, mobile: isMobileViewport }">
    <li>
      <router-link
        :to="{ name: 'Demo2Home', params: { lang: lang } }"
        @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >Home</router-link
      >
    </li>
    <li>
      <router-link :to="{ name: 'Demo2About' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >About</router-link
      >
    </li>
    <li>
      <router-link :to="{ name: 'Demo2Services' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
    ...
    <li>
      <router-link :to="{ name: 'Demo2Contact' }" @click="[closeMenuItemClick($event), closeOverlay($event)]"
        >Contact</router-link
      >
    </li>
  </ul>
